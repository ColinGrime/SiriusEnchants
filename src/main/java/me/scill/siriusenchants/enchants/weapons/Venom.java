		...
		switch (level) {
			case 1:
				if (RandomUtil.chance(3))
					potionEffect = CommonUtil.createPotionEffect(PotionEffectType.POISON, 2, 1);
				break;
			case 2:
				if (RandomUtil.chance(5))
					potionEffect = CommonUtil.createPotionEffect(PotionEffectType.POISON, 3, 1);
				break;
			case 3:
				if (RandomUtil.chance(8))
					potionEffect = CommonUtil.createPotionEffect(PotionEffectType.POISON, 4, 1);
				break;
		}
